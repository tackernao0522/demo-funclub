                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 already-registered-login">
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="exampleInputEmail1">町名・丁目・番地・マンション名等 <span class="text-danger">*</span></label>
                                                <textarea class="form-control" name="notes" cols="30" rows="5" placeholder="町名・丁目・番地・マンション名等" required="">{{ old('notes') }}</textarea>
                                                @error('notes')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
