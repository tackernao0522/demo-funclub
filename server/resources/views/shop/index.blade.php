                                ...
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="{{ url('product/details/' . $product->id . '/' . $product->product_slug_name) }}"><img src="{{ Storage::disk('s3')->url("products/thambnail/{$product->product_thambnail}") }}" alt="" style="width: 189px; height: 206px"></a> </div>
                                                    <!-- /.image -->
                            ...
                            <div class="item">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-post-info text-left">
                                        <h3 class="name"><a href="#">{{-- $blog->post_title_ja --}}</a></h3>
                                        <span class="info">{{-- Carbon\Carbon::parse($blog->created_at)->diffForHumans() --}}</span>
                                        <p class="text">{{-- {!! Str::limit($blog->post_details_ja, 100) !!} --}}</p>
