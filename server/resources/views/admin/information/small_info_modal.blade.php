...
<div class="ml-auto card-text text-center">
  <div class="dropdown pb-1 mt-4">
    ...
    <div class="dropdown-menu dropdown-menu-right" style="margin-top: 25px; width: 200px">
      <a class="dropdown-item" href="{{ route('small_image.edit', [$information->id]) }}">
        <i class="fas fa-pen mr-1"></i>編集する
      </a>
      <div class="dropdown-divider"></div>
      <a class="dropdown-item text-danger" data-toggle="modal" data-target="#modal-delete-{{ $information->id }}">
...
<!-- modal -->
<div id="modal-delete-{{ $information->id }}" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="{{ route('info.destroy', ['id' => $information->id]) }}">
        @csrf
        @method('DELETE')
