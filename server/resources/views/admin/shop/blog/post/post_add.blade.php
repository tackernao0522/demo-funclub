                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="post_blog_title" class="form-control" value="{{ old('post_blog_title') }}" required="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="category_id" class="form-control"style="color: red">
                                                        ...
                                                        <option value="{{ $blogCategory->id }}" {{ old('category_id') == $blogCategory->id ? 'selected': '' }}>{{ $blogCategory->blog_category_name }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('category_id')
                                                    <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea id="editor1" name="post_blog_details" rows="10" cols="80">ブログ投稿</textarea>
