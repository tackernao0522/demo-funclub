            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">市・区・町・村リスト <span class="badge badge-pill badge-danger">{{ count($districts) }}</span></h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <div class="table-responsive">
                            <form method="POST" action="{{ route('district.store') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select name="division_id" class="form-control" style="color: red">
                                ...
                                <div class="form-group">
                                    <h5>市・区・町・村<span class="text-danger">*</span></h5>
                                    <div class="controls">
