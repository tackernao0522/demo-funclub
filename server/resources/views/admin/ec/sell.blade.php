                ...
                <div class="panel-body">
                    ...
                    <form action="{{ route('sell') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="sub_theme" id="sub_theme" value="{{ old('sub_theme') }}" placeholder="50文字以内" />
                        </div>
                        {{-- サイズ --}}
                        <div class="form-group">
                            <label class="article" for="size">サイズ</label>
                            <input type="text" class="form-control" name="size" id="size" value="{{ old('size') }}" placeholder="50文字以内(任意)" />
                        </div>
                        {{-- カテゴリー --}}
                        <div class="form-group">
